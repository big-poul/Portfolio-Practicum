...
| [Построение модели машинного обучения для предсказания температуры стали](https://github.com/big-poul/Portfolio-Practicum/tree/75592300213c9f94b2cee2ce8b3b7f6a3323fbcd/Steel%20temperature) | Уменьшить потребление электроэнергии на этапе обработки стали |  Pandas, Matplotlib, scikit-learn, LightGBM, SHAP |
